...
class CrossProject extends StatelessWidget {
  const CrossProject({super.key});
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 100,),
            Text("Past CrossApp Project",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 25),),
            Padding(
