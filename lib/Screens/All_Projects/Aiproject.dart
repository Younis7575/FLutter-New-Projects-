...
class AiProject extends StatelessWidget {
  const AiProject({super.key});
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 100,),
            Text("Past Ai Project",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 25),),
            Padding(
