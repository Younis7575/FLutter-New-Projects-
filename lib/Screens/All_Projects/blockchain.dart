...
class BlockchainProject extends StatelessWidget {
  const BlockchainProject({super.key});
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 100,),
            Text("Past BlockChain Project",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 25),),
            Padding(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => SupervisorList(), // Corrected class name
                      //   ),
                      // );
                    },
