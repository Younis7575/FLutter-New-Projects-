...
class Supervisor3 extends StatefulWidget {
  const Supervisor3({Key? key}) : super(key: key);

  @override
  _Supervisor3State createState() => _Supervisor3State();
}

class _Supervisor3State extends State<Supervisor3> with SingleTickerProviderStateMixin {
        ...
        children: [
          Expanded(
            child: CustomTabBarScreen(
              imageUrl: 'https://www.uaar.edu.pk/media/profile/rubina-300922.JPG',
