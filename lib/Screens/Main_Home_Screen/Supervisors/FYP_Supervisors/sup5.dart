...
class Supervisor5 extends StatefulWidget {
  const Supervisor5({Key? key}) : super(key: key);

  @override
  _Supervisor5State createState() => _Supervisor5State();
}

class _Supervisor5State extends State<Supervisor5> with SingleTickerProviderStateMixin {
        ...
        children: [
          Expanded(
            child: CustomTabBarScreen(
              imageUrl: 'https://www.uaar.edu.pk/media/profile/MuhammadAqib-29-11-19.jpg',
