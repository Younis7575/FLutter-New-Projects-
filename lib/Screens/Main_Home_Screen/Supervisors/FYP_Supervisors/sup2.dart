...
class Supervisor2 extends StatefulWidget {
  const Supervisor2({Key? key}) : super(key: key);

  @override
  _Supervisor2State createState() => _Supervisor2State();
}

class _Supervisor2State extends State<Supervisor2> with SingleTickerProviderStateMixin {
        ...
        children: [
          Expanded(
            child: CustomTabBarScreen(
              imageUrl: 'https://www.uaar.edu.pk/media/profile/saif-26-07-19.jpg',
