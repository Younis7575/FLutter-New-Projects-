...
class Supervisor11 extends StatefulWidget {
  const Supervisor11({Key? key}) : super(key: key);

  @override
  _Supervisor11State createState() => _Supervisor11State();
}

class _Supervisor11State extends State<Supervisor11> with SingleTickerProviderStateMixin {
        ...
        children: [
          Expanded(
            child: CustomTabBarScreen(
              imageUrl: 'https://www.uaar.edu.pk/media/profile/sadia-201222.jpg',
              name: 'Dr.Sadia Ali',
              onPressed: () {
